<h2>945. Minimum Increment to Make Array Unique</h2><h3>Medium</h3><hr><div><p>Given an array of integers A, a <em>move</em> consists of choosing any <code>A[i]</code>, and incrementing it by <code>1</code>.</p>
